...
linkWithSameTitleUser= Links.findOne({title: linkAttributes.title, userId: linkAttributes.userId});
	...
	if (linkAttributes.title && linkWithSameTitleUser) { throw new Meteor.Error(302,
