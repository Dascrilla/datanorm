...
Router.map(function() {
  ...
  this.route('sfdcQueue', {
    path: '/queue',
    waitOn: function() {
      return Meteor.subscribe('queueItems');
  }, 
     onBeforeAction: function () {
      AccountsEntry.signInRequired(this);
    }
   ...
   this.route('sfdcItem', {
    waitOn: function() {
     ...
     data: function() { return QueueItems.findOne(this.params._id); }
  });


  this.route('queueSubmit', {
    path: '/queue_submit', 
    waitOn: function() {
      return Meteor.subscribe('queueItems');
    }, 
...
this.route('linkSubmit', {
  ...
  this.route('docPage', {
    path: '/docs/:_id',
    waitOn: function() {
      return Meteor.subscribe('docs, links');
    },
